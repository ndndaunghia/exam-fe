...
const TestItem = () => {
  ...
  return (
    ...
    className="max-w-fit p-4 rounded-2xl border-2 shadow-xl">
      <h2 className="font-semibold dark:text-white">IELTS Simulation Listening test 1</h2>
      <div className="flex gap-4 my-4">
        <div className="flex items-center gap-2">
          <CiClock2 color={theme === 'light' ? 'black' : 'white'}/>
          <p className="dark:text-white"> 30 phút</p>
        </div>
      ...
      <div className="flex gap-2 my-4">
        <p className="dark:text-white">2 phần thi</p>
        <p className="dark:text-white">|</p>
        <p className="dark:text-white">40 câu hỏi</p>
      </div>
