...
export default function Header() {
    ...
    return (
        <header className="bg-white shadow-md fixed top-0 left-0 right-0 z-50">
            ...
            <Transition appear show={isLoginFormOpen} as={Fragment}>
                <Dialog
                    as="div"
                                        ...
                                        <div className="w-full bg-white  md:mt-0 xl:p-0">
                                            <div className="p-6 space-y-4 md:space-y-6 sm:p-4">
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        type="submit"
                                                        className="w-full text-gray-900 bg-[#009e6a] :bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center text-white"
                                                    >
                                                        Đăng nhập
                                                    </button>
